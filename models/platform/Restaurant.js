...
const restaurantSchema = new mongoose.Schema(
  {
    ...
    /** Daily AM/PM admin-panel billing pings (Asia/Kolkata calendar day) */
    billingReminderSlots: {
...
restaurantSchema.pre("save", function () {
  if (this.isModified("subscriptionExpiry")) {
    this.reminderSent5Day = false;
    this.reminderSent3Days = false;
    this.reminderSent1Day = false;
    this.billingReminderSlots = { dateKey: "", morning: false, evening: false };
  }
});
